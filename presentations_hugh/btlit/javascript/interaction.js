...
var currentfocus=3;
var timerCountdown = document.timerCountdown;
...
//   alert( e.keyCode );
  ...
  //  $("#innercontainer13").load("https://www.comp.nus.edu.sg/~hugh/index.html");
  //  $("#innercontainer13").html('<object data = "https://hughanderson.org/uploads/latestDYDX.html" width=\"100%\" height=\"100%\" left=\"5px\" top=\"5px\">');
  ...
  fixDiv(currentdiv,0,0);
    ...
    if ( e.keyCode == 81 ) { // Do a question... Q
     ...
     //    document.getElementById('canvasForQuiz').focus();
      ...
      var quizEvent = new Event('quizTriggered');
      console.log('quizEvent ' + quizEvent)
      var quizCodeBox = document.getElementById('quizCode'); 
      quizCodeBox.dispatchEvent(quizEvent);
      console.log('quizEvent dispatched')
      // document.body.dispatchEvent(quizEvent)
     ...
     starwarsmp3.pause();
      ...
      dataval="https://hugh.comp.nus.edu.sg/cs2107/Askbox/AskboxADM.php";

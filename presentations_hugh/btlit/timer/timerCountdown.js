...
SegmentDisplay.prototype.getSegmentColor = function(c, charSet7, charSet14, charSet16) {
  ...
  display.colorOn         = "#e4a700";
  display.colorOff        = 'transparent';
  display.draw();
	...
	my.startClock = function() {
            intervalID = window.setInterval('timerCountdown.clockAnimate()', 100);
	};

        my.stopClock = function() {
            window.clearInterval(intervalID);
	};

	my.clockAnimate = function () {
	       time    = new Date();
    hours   = time.getHours();

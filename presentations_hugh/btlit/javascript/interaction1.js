...
function frameConverter(video,canvas,dv) {
	...
	//       var loccanvas = document.getElementById("innercontainer6");
	//loccanvas.remove();
	//var e = document.getElementById("visible6b");
	//var c = makeCanvas( "innercontainer6","640","480","",false,false );
	//e.appendChild(c);
	//setDivSize(6);
       var loccanvas = document.getElementById("innercontainer6");
       var locviewport = loccanvas.getContext("2d");
       //      locviewport.clearRect(0,0,locviewport.canvas.width,locviewport.canvas.height);
       //       console.log(locviewport.canvas);       
       //       locviewport.drawImage(this.video, 0,0,locviewport.canvas.width,locviewport.canvas.height);

              locviewport.drawImage(this.video, leftinneridx[dv],topinneridx[dv], this.video.videoWidth/scale[currwidthscale[dv]],
